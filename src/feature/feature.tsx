...
const Wrapper = styled.div`
	width: 90%;
	max-width: 1280px;
	${(props: FeatureProps) => (props.layout === FeatureLayout.Center) ? `
		display: block;
	` : `
		display: block;
...
const StyledAppFrame = styled(AppFrame)`
	...
	${(props: FeatureProps) => {
		switch (props.layout) {
			case FeatureLayout.Left: return `
				@media screen and (min-width: 960px) {
					transform: translate(50%,0);
				}
			`;
			case FeatureLayout.Right: return `
				@media screen and (min-width: 960px) {
					transform: translate(-50%,0);
				}
			`;
			default: case FeatureLayout.Center: return '';
		}
	}};
...
const StyledBox = styled.div`
	...
	${(props: FeatureProps) => (props.layout === FeatureLayout.Right) ? `
		@media screen and (min-width: 960px) {
			left: 60%;
		}
	` : ''};
