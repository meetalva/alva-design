...
export const render = (input: any) => {
	...
	result.after = [result.after, helmet.script.toString()].join("\n");
	...
	return (
		<div style={{ overflow: "hidden" }}>
			...
			<Section backgroundColor={Color.Black} textColor={Color.White}>
				...
				<Layout maxWidth="640px">
					<Copy size={CopySize.Large}>
						...
						And guess what – we are entirely open source.
					</Copy>
				</Layout>
			...
			<Feature
				...
				link={
					<a
						...
						rel="noopener"
					>
						<Link color={Color.Violet}>Learn how to prototype with code components</Link>
					</a>
				}
				negativeTop
			/>
			...
			<Feature
				...
				link={
					<a
						...
						rel="noopener"
					>
						<Link color={Color.Violet}>Learn how to integrate your designs</Link>
					</a>
				}
			/>
			<Space size={SpaceSize.XL} />
			<Feature
				...
				link={
					<a
						...
						rel="noopener"
					>
						<Link color={Color.Violet}>Learn how to work with interactions</Link>
					</a>
				}
			/>
			<Space size={SpaceSize.XL} />
			...
			<Footer copyright="&copy; 2018 Alva">
				<MenuItem linkName="hey@meetalva.io" rel="noopener" href="mailto:hey@meetalva.io" />
				<MenuItem
